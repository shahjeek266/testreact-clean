...
const ApexTier = ({ isActive = false }: SlideProps) => {
  ...
  return (
    <section className="flex justify-around">
     ...
     <a
  href="https://res.cloudinary.com/dj2zq210a/video/upload/v1751962951/Apex_Tier_Show_yuzuco.mp4"
  target="_blank"
        ...
        <div className="flex items-start justify-center mt-8">
          <div className="rounded-xl overflow-hidden w-[640px] h-[920px] relative">
            <video
              ...
              muted
            >
              <source src="https://res.cloudinary.com/dj2zq210a/video/upload/v1751829506/apexvideo_kybjqn.mp4" type="video/mp4" />
